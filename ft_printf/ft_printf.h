...
int		print_integer(int d, int length, t_options *options);
int		print_uinteger(unsigned int d, int length, t_options *options);
int		print_hex(unsigned int u, int length, t_options *options);
int		print_he0(unsigned int u, int length, t_options *options);
